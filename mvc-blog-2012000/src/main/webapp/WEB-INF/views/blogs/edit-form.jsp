      ...
      <div class="col-lg-8 col-md-10 mx-auto">
        ...
        <form action="../blogs" method="post" enctype="multipart/form-data" 
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Content</label>
              <textarea rows="5" class="form-control" name="content" placeholder="Content" id="name" required data-validation-required-message="Please enter a message.">
              ${blog.content }
              </textarea>
              <p class="help-block text-danger"></p>
            </div>
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              <label>Blogger</label>
              <input type="text" class="form-control" name="blogger" value="${blog.blogger }"placeholder="Blogger" id="name" required data-validation-required-message="Please enter your name.">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <br>
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-primary" id="sendMessageButton">업데이트</button>
            <button type="reset" class="btn btn-primary" id="sendMessageButton">취소</button>
          </div>
        </form>
      </div>
    </div>
